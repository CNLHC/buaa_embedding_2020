...
//Todo：例如0x80代表亮数码管的第一段
unsigned char bit_map[8] = {
	0x80,0x40,0x20,0x10,0x08,0x04,0x02,0x01//补全：
};
...
unsigned char hex_map[16] = {
		...
		0xfe, 0xf6, 0xee, 0x3e, 0x9c, 0x7a, 0x9e, 0x8e // online website code
	//0xfc, 0x0c, 0xb6, 0x9c, 0x4e, 0xda, 0xfa, 0x8c, 0xfe, 0xce, 0xee, 0x7a, 0xf0, 0x3e, 0xf2, 0xe2 // 补全, 这里不太确定,按照上方第一条为第一段, 之后逆时针为第二,三段, 最后中间的一条为第七段,  第八段 is dp
};
